<script>
	...
	import { dataGetter } from '$lib/database.js';
	let data = dataGetter('locale');
</script>
	...
	{#await data then locale}
		<div class="centX">
			<div>
				...
				<img src="/icons/people.svg" alt="people icon" class="flex my-0 mx-auto" />
			...
			<div class="flex flex-col sm:flex-row">
				<div class="w-11/12 sm:w-[48%] h-full bg-blue-600 mt-10 p-5 my-0 mx-auto rounded-xl">
					<img src="/icons/phone.svg" alt="phone icon" class="flex my-0 mx-auto" />
				...
				<div class="w-11/12 sm:w-[48%] h-full bg-green-600 mt-10 p-5 my-0 mx-auto rounded-xl">
					<img src="/icons/email.svg" alt="email icon" class="flex my-0 mx-auto" />
					...
					<div class="flex flex-col items-center justify-around pt-2">
						<div class="w-full grid grid-cols-4 pt-4">
							<div class="flex flex-col justify-center items-center">
								<img src="/icons/vscode.png" class="h-10 w-10" alt="vs-code icon" />
								<p class="pt-2">VS Code</p>
							</div>
							<div class="flex flex-col justify-center items-center">
								<img src="/icons/html.svg" class="h-10 w-10" alt="html icon" />
								<p class="pt-2">HTML</p>
							</div>
							<div class="flex flex-col justify-center items-center">
								<img src="/icons/css.png" class="h-10 w-10" alt="css icon" />
								<p class="pt-2">CSS</p>
							</div>
							<div class="flex flex-col justify-center items-center">
								<img src="/icons/js.png" class="h-10 w-10" alt="js icon" />
								<p class="pt-2">JavaScript</p>
							</div>
						</div>
						<div class="w-full grid grid-cols-4 pt-8">
							<div class="flex flex-col justify-center items-center">
								<img src="/icons/github.png" class="h-10 w-10" alt="github icon" />
								<p class="pt-2">GitHub</p>
							</div>
							<div class="flex flex-col justify-center items-center">
								<img src="/icons/vite.png" class="h-10 w-10" alt="vite icon" />
								<p class="pt-2">Vite</p>
							</div>
							<div class="flex flex-col justify-center items-center">
								<img src="/icons/svelte.png" class="h-10 w-10" alt="svelte icon" />
								<p class="pt-2">Svelte</p>
							</div>
							<div class="flex flex-col justify-center items-center">
								<img src="/icons/tailwind.svg" class="h-10 w-10" alt="tailwind icon" />
